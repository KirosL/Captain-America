...
import "./Compañeros.css";
class Compañeros extends Component {
    ...
    peticionGet = () => {
        fireDb.child("Compañeros").on("value", (aliado) => {
        if (aliado.val() !== null) {
    ...
    peticionPost=()=>{
        fireDb.child("Compañeros").push(this.state.form,
        error=>{
    ...
    peticionPut=()=>{
        fireDb.child(`Compañeros/${this.state.id}`).set(
        this.state.form,
        error=>{
            if(error)console.log(error)
        });
    ...
    peticionDelete=()=>{
        ...
        {
        fireDb.child(`Compañeros/${this.state.id}`).remove(
        error=>{
            if(error)console.log(error)
        });
        }
